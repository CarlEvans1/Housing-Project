...
from Properties.views import AddCaretakerToBuildingView, AddTenantToBuildingView, BuildingClassView, BuildingDetailView, BuildingFormView, DeleteBuildingView, DeleteCaretakerView, TenantDeleteView, TenantDetailView,UpdateBuildingView, UpdateCaretakerView, UpdateTenantView
